...
import com.JA.blergb.misc.StringHandler;
import com.JA.blergb.vspservice.VSPManager;
...
public class SerialManager extends VSPManager{
    ...
    private SerialUiManagerCallback mSerialUiManagerCallback;
    
    
    public SerialManager(Activity activity, VSPUiCallback uiVSPCallback,
            SerialUiManagerCallback serialUiManagerCallback, int maxDataToBeReadFromRxBuffer) throws NullPointerException {
